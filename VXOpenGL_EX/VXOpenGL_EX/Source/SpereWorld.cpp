...
{
    static GLfloat vWhite[] = {1.0f, 1.0f, 1.0f, 1.0f};
    static GLfloat vLightPos[] = {0.0f, 3.0f, 1.0f, 1.0f};
...
void SetupRC(void)
{
    ...
    rectReplaceShader = gltLoadShaderPairWithAttributes("SpereVertex.glsl", "SpereFragment.glsl", 
                                                        2, GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_TEXTURE0, "vTexCoord");
    
    
    localRectMVP = glGetUniformLocation(rectReplaceShader, "mvpMatrix");
    localRectTexture = glGetUniformLocation(rectReplaceShader, "rectangleImage");
...
/*
{
    ...
    rectReplaceShader = gltLoadShaderPairWithAttributes("SpereVertex.glsl", "SpereFragment.glsl", 2, GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_TEXTURE0, "vTexCoord");
    localRectMVP = glGetUniformLocation(rectReplaceShader, "mvpMatrix");
    localRectTexture = glGetUniformLocation(rectReplaceShader, "rectangleImage");
...
void RenderScene(void)
{
    ...
    glUniform1i(localRectTexture, 0);
    glUniformMatrix4fv(localRectMVP, 1, GL_FALSE, mScreenSpace);
    glBindTexture(GL_TEXTURE_RECTANGLE, uiTextures[3]);
    logoBatch.Draw();
...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("Texture Reactangle");
